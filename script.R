...
arq_novo <- "SBT-A-1-PL191715-= -PL-1917-2015.pdf"

trata_projeto_lei = function(arquivo) {
  ...
  return(projeto_tratado)
}

a <- trata_projeto_lei(arq_antigo)
b <- trata_projeto_lei(arq_novo)